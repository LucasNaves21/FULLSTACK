...
public class Main {
	...
	public static void main(String[] args) throws MinhaExeption, ParseException {
		...
		PessoaFisica luiz = new PessoaFisica(1, "Luiz", "Anápolis", "999", new Date(2002-1900, 12-1, 1), "Masculino");
		@SuppressWarnings("deprecation")
		PessoaFisica maria = new PessoaFisica(2, "Maria", "Goiânia", "888", new Date(2001-1900, 9-1, 10), "Feminino");
